...
The 2023 cancel-and-reissue chain on NLMC0003326 → NLMC0003326-CA → NLMC0003400
...
==========================================================================================
 ...
 PRE-CHECK - verifying each of the 4 target rows has the old +551:
   acct_gl id=1364286       debit=551.00   OK
   acct_gl id=1364287       credit=551.00  OK
   acct_balance id=552562   debit=551.00   OK
   acct_balance id=552634   credit=551.00  OK
